package com.wzp.u.hi.ui.tab.bottom;
...
import com.wzp.hi.library.util.HiViewUtil;
...
public class HiTabBottomLayout extends FrameLayout implements IHiTabLayout<HiTabBottom, HiTabBottomInfo<?>> {
    ...
    private void addBackground() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.hi_tab_bottom_layout_bg, null);
