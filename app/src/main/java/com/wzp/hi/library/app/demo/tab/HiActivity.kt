...
import com.wzp.u.hi.ui.tab.bottom.HiTabBottomInfo
import com.wzp.u.hi.ui.tab.bottom.HiTabBottomLayout
...
//        },2000)
        hiTabBottomLayout.addTabSelectedChangeListener { _, _, nextInfo ->
            Toast.makeText(this@HiActivity, nextInfo.name, Toast.LENGTH_SHORT).show()
        }
        hiTabBottomLayout.defaultSelected(homeInfo)
        //        改变某个tab的高度
